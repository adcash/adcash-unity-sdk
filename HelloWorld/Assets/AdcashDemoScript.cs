...
public class AdcashDemoScript : MonoBehaviour
{
	...
	private void RequestBanner()
	{
		...
		#elif UNITY_ANDROID
		string adUnitId = "409358";
		#elif UNITY_IPHONE
		string adUnitId = "295055";
		#else
		string adUnitId = "409358";
		#endif
		
		// Create a 320x50 banner at the top of the screen.
		bannerView = new BannerView(adUnitId, AdSize.AdSizeSmartBanner, AdPosition.Bottom);
	...
	private void RequestInterstitial()
	{
		...
		string adUnitId = "unused";
		#elif UNITY_ANDROID
		string adUnitId = "409357";
		#elif UNITY_IPHONE
		string adUnitId = "295054";
		#else
		string adUnitId = "409357";
		#endif
